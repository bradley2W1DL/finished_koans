...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # * would only fail to match if there were no string
  end
  ...
  #
  # Why?
  # because they will continue to return as many letters as possible
  # given the expression.  It will grab as much data as it can, which can
  # cause issues; lots of backtracking.
